...
import com.ticketsalescompany.model.User;
import com.ticketsalescompany.model.Admin;
...
public class AccountService {
    ...
    public AccountService(IRepository<User> userRepository, CustomerService customerService) {
        ...
        this.adminFileRepository = new FileRepository<>("src/main/java/com/ticketsalescompany/repository/data/admins.csv", Admin::fromCsv);
        this.customerFileRepository = new FileRepository<>("src/main/java/com/ticketsalescompany/repository/data/customers.csv", Customer::fromCsv);
        syncFromCsv();
